...
It also migrates existing folder contents, updates registry paths, add a symlink on the desktop and refreshes Explorer so the changes take effect immediately.
